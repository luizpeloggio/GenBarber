...
public class historicoCliente implements Initializable {
	...
	public void carregarHistorico() {
		...
		if (agendamentos.isEmpty()) {
			containerContent.getChildren()
					.add(new Label("Nenhum agendamento encontrado para o CPF " + cpfClienteLogado + "."));
			return;
		}
	...
	private VBox criarItemAgendamento(Agendamento agendamento) {
		...
		itemHBox.setStyle(
				"-fx-border-color: #ccc; -fx-border-width: 1px; -fx-padding: 10; -fx-background-color: #f4f4f4;");
